...
if ( !function_exists( 'digiboost_filter_icons_icon_set' ) ) :
	function digiboost_filter_icons_icon_set ( $sets ) {
		$sets['theme-fa-icons'] = array(
			...
			'groups' => array(
				'web-application' => esc_html__( 'Web Application Icons', 'digiboost' ),
				
				'hand' => esc_html__( 'Hand Icons', 'digiboost' ),
				'transportation' => esc_html__( 'Transportation Icons', 'digiboost' ),
				'gender' => esc_html__( 'Gender Icons', 'digiboost' ),
				'file-type' => esc_html__( 'File Type Icons', 'digiboost' ),
				
				'payment' => esc_html__( 'Payment Icons', 'digiboost' ),
				
				'currency' => esc_html__( 'Currency Icons', 'digiboost' ),
				'text-editor' => esc_html__( 'Text Editor Icons', 'digiboost' ),
				'directional' => esc_html__( 'Directional Icons', 'digiboost' ),
				'video-player' => esc_html__( 'Video Player Icons', 'digiboost' ),
				'brand' => esc_html__( 'Brand Icons', 'digiboost' ),
				'medical' => esc_html__( 'Medical Icons', 'digiboost' ),
				'flaticon' => esc_html__( 'Flat Icons', 'digiboost' ),
				'icon-fonts' => esc_html__( 'Fontello Icons', 'digiboost' ),
				'ico' => esc_html__( 'Icomoon Icons', 'digiboost' ),
			),
			'icons' => array(
...
endif; //digiboost_filter_icons_icon_set
add_filter( 'fw_option_type_icon_sets', 'digiboost_filter_icons_icon_set' );


if ( !function_exists( 'digiboost_filter_megamenu_icon_set' ) ) {
	function digiboost_filter_megamenu_icon_set ( $array_set ) {
		$array_set['set'] = 'theme-fa-icons';
		
		return $array_set;
	}
}
add_filter( 'fw:ext:megamenu:icon-option', 'digiboost_filter_megamenu_icon_set' );