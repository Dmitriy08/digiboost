...
?>
	<div id="content" class="<?php echo esc_attr( $column_classes['main_column_class'] ); ?>">
		...
		// ?>
		<?php if ( have_posts() ) : ?>
			<div class="isotope-wrapper row shortcode-service masonry-layout c-gutter-30 c-mb-30"
			...
			>
				...
				while ( have_posts() ) : the_post();
					...
					?>
					<div
						class="isotope-item col-xl-4 col-md-6   <?php echo esc_attr( $sort_classes[get_the_ID()] ); ?>">
						<?php
