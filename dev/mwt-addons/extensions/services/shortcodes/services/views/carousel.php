...
?>
<div
	class="owl-carousel owl-shadowitems shortcode-service <?php echo esc_attr($nav_position)?>"
...
>
	...
	?>
	<div class="owl-carousel-item <?php echo esc_attr( $sort_classes[get_the_ID()].' '.$align ); ?>">
		<?php
