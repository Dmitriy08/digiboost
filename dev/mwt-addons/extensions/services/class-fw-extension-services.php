...
class FW_Extension_Services extends FW_Extension {
	...
	public function _filter_admin_add_post_options( $options, $post_type ) {
		if ( $post_type === $this->post_type ) {
            ...
            $features = $shortcodes_extension->get_shortcode( 'progress_bar' )->get_options();
			$options[] = array(
				'icon_box' => array(
					'context' => 'side',
                ...
                'services_features' => array(
                    'title'   => __( 'Service Features', 'mwt' ),
                    'type'    => 'tab',
                    'options' => array(
                        'features' => array(
                            'type'            => 'addable-box',
                            'value'           => '',
                            'label'           => esc_html__( 'Features', 'mwt' ),
                            'desc'            => esc_html__( 'Optional service feature', 'mwt' ),
                            'template'        => '{{=title}}',
                            'box-options'     => array(
                                $features
                            )
                ...
                'services_meta' => array(
                    ...
                    'options' => array(
                        'about' => array(
                            ...
                            'label' => __('Service Meta Text After Features', 'mwt'),
                            'wpautop' => true,
