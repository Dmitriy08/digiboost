...
$column_classes = digiboost_get_columns_classes( true );
	...
	<div id="content" class="col-lg-10 offset-lg-1">
		...
		while ( have_posts() ) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'text-center' ); ?>>
				<div class="gallery-item vertical-item portfolio-single content-padding box-shadow text-center">
					<div class="item-media">
						...
						if ( ! empty( $thumbnails ) ) :
							...
							the_post_thumbnail( 'digiboost-full-width' );
