...
$section = digiboost_get_section_options($atts);
$section_overflow_visible_class = (!empty($atts['overflow_visible'])) ? 'overflow-visible' : '';

$container_shadow = (!empty($section['section_container_class'])) ? $section['section_container_class'] : '';
...
if ((!empty($atts['background_video']['type']) && !is_admin())) {
    ...
    digiboost_unyson_enqueue_section_video_background_scripts();
...
<section
        class="<?php echo esc_attr(trim($section_overflow_visible_class . ' ' . $section['section_class'] . ' ' . $container_additional_class)); ?>"
...
>
    ...
    if (!empty($atts['side_media_image'])) : ?>
        <div class="cover-image <?php echo esc_attr('ds '.$atts['side_media_overlay'])?> <?php echo (!empty($atts['side_media_position'])) ? esc_attr('s-cover-' . $atts['side_media_position']) : ''; ?> <?php echo (!empty($atts['side_media_width'])) ? esc_attr($atts['side_media_width']) : ''; ?> <?php echo (!empty($atts['side_media_visibility'])) ? esc_attr($atts['side_media_visibility']) : ''; ?>">
            <?php if ($link): ?>
    ...
    ?>
    <div class="container<?php echo esc_attr($section['section_container_class_suffix'].' '.$container_shadow); ?>">
